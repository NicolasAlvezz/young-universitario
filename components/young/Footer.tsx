      ...
      <div className="container-yu py-16">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12">
          <div className="md:col-span-2">
            ...
            <p className="text-club-muted text-sm leading-relaxed max-w-xs mb-8">Club Deportivo Young Universitario. Fútbol, Hockey y Básquetbol. Pasión, esfuerzo y comunidad en cada competencia.</p>
